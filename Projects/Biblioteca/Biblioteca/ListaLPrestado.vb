Public Class ListaLPrestado
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles ListaP.CellContentClick

    End Sub

    Private Sub ListaLPrestado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        wsql = "select* from libros where prestado=" & 1
        ...
        If obj_dr.HasRows Then
            Do While obj_dr.Read
                ...
                ListaP.Rows.Add(xid, xid_libro, xnomlibro)
